...
const paragraphs = [
  "I wrote my first lines of code in 2017, drawn to programming as a craft I could grow with and never fully master. I'm driven to build software and tools that add to people's quality of life.",
